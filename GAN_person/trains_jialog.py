...
batch_size = 200
num_epoch = 10
data = Datasets(r"D:\shujuji\图像训练数据_GAN")
...
for epoch in range(500):
    for i,img in enumerate(data):
        ...
        z = torch.randn(img.size(0),64,1,1).to(device)
        fake_img = g_net(z)
        ...
        if i % 50 == 0:
            ...
            save_image(real_img, "./img/{}-{}-real_img.jpg".format(epoch , i), nrow=10)
            save_image(fake_img, "./img/{}-{}-fake_img.jpg".format(epoch , i), nrow=10)
            print("保存图片成功")
